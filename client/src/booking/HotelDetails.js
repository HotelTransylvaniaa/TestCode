        ...
        <div className='container border border-2 p-2 mt-3'>
          <div className='row'>
            <div className='col-md-12 p-1 '>
              ...
              {new Array(hotelDetails.rating).fill(0).map(() => ( <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" className="bi bi-star-fill  me-1 mb-2" viewBox="0 0 16 16">
                ...
                <div className="card border rounded my-3 shadow" key={r.roomId}>
                  ...
                  <div className="d-flex p-3">
                    {auth && auth.token ? <button className="btn btn-primary mt-5 ms-auto" data-bs-toggle="modal" data-bs-target={`#exampleModal${index}`}>
                      ...
                      :
                      <button className="btn btn-primary mt-5 ms-auto" onClick={goToLogin}>
                        Login To book
                      </button>}
                  </div>
