...
export default function LoginForm({handelFormChange,userFormErrors,handleFormSubmit, userForm}){
  ...
  <div className='row'>
      <div className='col-md-7 m-auto '>
          <div className='card mt-5 bg-dark opacity-75  '>
              <div className='card-title text-center mt-3'>
                  <img src='http://cognitive-physio.com/assets/images/user.jpg' width="100px" height="100px" className='rounded-circle mt-3 text-white'></img>
              </div>
      ...
      <div className="mb-3 input-group m-auto" controlid="formBasicPassword">
      ...
      <button disabled={userFormErrors.userEmailErr||userFormErrors.passwordErr} className="btn btn-secondary m-3 text-center" type="submit">
          Submit
      </button>
    </form>
    </div>
