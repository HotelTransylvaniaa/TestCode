            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mb-2 mb-lg-0 ms-5">
                        ...
                        <Link className="nav-link active text-decoration-none"  to={"/"} exact="true">Home</Link>
                        </li>
                        <li className="nav-item me-2 fs-5">
                        <Link className="nav-link text-decoration-none"  to={"/hotels"} exact="true">Hotels</Link>
                        </li>
                        <li className="nav-item me-2 fs-5">
                        <Link className="nav-link text-decoration-none"  to={"/contact-us"} exact="true">Contact Us</Link>
                        </li>
                    </ul>
